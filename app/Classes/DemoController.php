...
class DemoController extends MvcUIController
{
    ...
    public function apropos() {
        echo $this->render('Layouts.default', 'Templates.Demo.apropos', null, 'A propos');
    }

    public function realisations() {
        echo $this->render('Layouts.default', 'Templates.Demo.realisations', null, 'Réalisations');
    }

    public function contact() {
        echo $this->render('Layouts.default', 'Templates.Demo.contact', null, 'Contact');
    }
}